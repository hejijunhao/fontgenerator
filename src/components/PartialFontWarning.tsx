...
export function PartialFontWarning({ codepoints }: PartialFontWarningProps) {
  ...
  return (
    <div
      role="status"
      className="rounded-xl border border-amber-300/50 bg-amber-50/80 px-4 py-3 text-sm text-amber-950"
    >
      <p className="font-medium">Partial font</p>
      <ul className="mt-1 list-inside list-disc space-y-0.5 text-xs text-amber-950/85">
